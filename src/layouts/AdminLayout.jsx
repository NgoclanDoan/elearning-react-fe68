      ...
      <Sider trigger={null} collapsible collapsed={collapsed}>
        ...
        <Menu theme="dark" mode="inline" defaultSelectedKeys={["1"]}>
          ...
          <Menu.Item key="2" icon={<UserOutlined />}>
            <NavLink to="/admin/nguoidung">Quản lý người dùng</NavLink>
          </Menu.Item>
          <SubMenu key="sub1" icon={<VideoCameraOutlined />} title="Khóa học">
            <Menu.Item key="3">
              <NavLink to="/admin/khoahoc">Quản lý khóa học</NavLink>
            </Menu.Item>
            <Menu.Item key="4">
              <NavLink to="/admin/khoahoc/add">Thêm khóa học</NavLink>
            </Menu.Item>
          </SubMenu>
